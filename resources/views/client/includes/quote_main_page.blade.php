							...
							<div class="device_info_block">
								...
								<div class="description" style="min-height:300px;">
									...
									<div class="col-md-6 device_photo" style="background:#51b2df; height:300px; margin-bottom: 40px;">
										<img src="{{ url('/img/devices', $quoted_device->image) }}" style="
		display: block;
		width: 200px;
		height: 200px; 
		margin-top: -100px;
		...
		top: 50%;"/>
				...
				<div style="width:100%; margin-top:50px;">
					<h4 style="font-weight:bold; text-align:center; margin-bottom:30px;">
						...
						@foreach ($quoted_devices as $quoted_device)
							<div class="col-md-2" style="height:55px; background:#efefef; border-left:2px solid #d8d8d8; padding:15px; font-size:16px; cursor:pointer;" ng-click="showQuotedDevice({{ $quoted_device->id }})">
								{{ $quoted_device->model }}
							</div>
						@endforeach
					</h4>
