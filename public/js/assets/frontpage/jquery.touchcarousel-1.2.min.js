...
this._w?(this._b1="-webkit-transform",this._c1="translate3d(",this._d1="px, 0, 0)"):(this._b1="left",this._c1="",this._d1="px");this.hasTouch&&(this.settings.directionNavAutoHide=!1);this.settings.directionNav||(this._f1=this.settings.loopItems?this._e1=!0:this._e1=!1,this.settings.loopItems=!0);var p,h,n=0;g.eq(this.numItems-1).addClass("last");
g.each(function(b){h=f(this);p={};p.item=h;p.index=b;p.posX=n;

p.posX = n;
var width = h.outerWidth();
if (width < d.settings.itemMinWidth) {
    width = d.settings.itemFallbackWidth;
}
p.width = width;
n += p.width;

if (d.settings.itemMargin) {
    var margins = (b === 0 || b === (g.length-1)) ? d.settings.itemMargin : 2*d.settings.itemMargin;
    n += margins;
}

if(this.hasTouch){var a;h.find("a").each(function(){a=
