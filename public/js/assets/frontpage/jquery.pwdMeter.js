...
jQuery.fn.pwdMeter = function(options){
	...
	return this.each(function(index){
		...
		function evaluateMeter(){
			...
			var password = $.trim($(options.passwordBox).val());
            ...
            /* by bear - changed from removeClass() as it does not delete classes for some reason on new frontpage */
			$('#pwdMeter').removeClass("veryweak weak medium strong verystrong neutral");
			...
			case 6:
			  ...
			  break;		  		  		  
			default:
			  $('#pwdMeter').addClass('veryweak'); /* by bear - changed from neutral as it shows default in strange cases even if there are symbols */
			  $('#pwdMeter').text('Very Weak');
			}		
